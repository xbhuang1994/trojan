...
if [[ $TYPE == 0 ]];then
    ...
    CHECKVERSION="https://api.github.com/repos/xbhuang1994/trojan-go/releases"
fi
NAME=trojan
...
if [[ $TYPE == 0 ]];then
    ...
    DOWNLOADURL="https://github.com/xbhuang1994/trojan-go/releases/download/v$VERSION/$TARBALL"
fi
